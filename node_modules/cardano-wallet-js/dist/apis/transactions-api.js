        ...
        listTransactions: function (walletId, start, end, order, minWithdrawal, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarPath = "/wallets/{walletId}/transactions"
                        .replace("{" + "walletId" + "}", encodeURIComponent(String(walletId)));
                    localVarUrlObj = new URL(localVarPath, 'https://example.com');
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
        ...
        postTransactionFee: function (body, walletId, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarPath = "/wallets/{walletId}/payment-fees"
                        .replace("{" + "walletId" + "}", encodeURIComponent(String(walletId)));
                    localVarUrlObj = new URL(localVarPath, 'https://example.com');
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
...
exports.TransactionsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        deleteTransaction: function (walletId, transactionId, options) {
            return exports.TransactionsApiFp(configuration).deleteTransaction(walletId, transactionId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Get transaction by id.
         * @summary Get
         ...
         */
        getTransaction: function (walletId, transactionId, options) {
            return exports.TransactionsApiFp(configuration).getTransaction(walletId, transactionId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Lists all incoming and outgoing wallet's transactions.
         * @summary List
         ...
         */
        listTransactions: function (walletId, start, end, order, minWithdrawal, options) {
            return exports.TransactionsApiFp(configuration).listTransactions(walletId, start, end, order, minWithdrawal, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Create and send transaction from the wallet.
         * @summary Create
         ...
         */
        postTransaction: function (body, walletId, options) {
            return exports.TransactionsApiFp(configuration).postTransaction(body, walletId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Estimate fee for the transaction. The estimate is made by assembling multiple transactions and analyzing the distribution of their fees. The estimated_max is the highest fee observed, and the estimated_min is the fee which is lower than at least 90% of the fees observed.
         * @summary Estimate Fee
         ...
         */
        postTransactionFee: function (body, walletId, options) {
            return exports.TransactionsApiFp(configuration).postTransactionFee(body, walletId, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var TransactionsApi = /** @class */ (function (_super) {
    ...
    TransactionsApi.prototype.deleteTransaction = function (walletId, transactionId, options) {
        var _this = this;
        return exports.TransactionsApiFp(this.configuration).deleteTransaction(walletId, transactionId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Get transaction by id.
     * @summary Get
    ...
    TransactionsApi.prototype.getTransaction = function (walletId, transactionId, options) {
        var _this = this;
        return exports.TransactionsApiFp(this.configuration).getTransaction(walletId, transactionId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Lists all incoming and outgoing wallet's transactions.
     * @summary List
    ...
    TransactionsApi.prototype.listTransactions = function (walletId, start, end, order, minWithdrawal, options) {
        var _this = this;
        return exports.TransactionsApiFp(this.configuration).listTransactions(walletId, start, end, order, minWithdrawal, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Create and send transaction from the wallet.
     * @summary Create
    ...
    TransactionsApi.prototype.postTransaction = function (body, walletId, options) {
        var _this = this;
        return exports.TransactionsApiFp(this.configuration).postTransaction(body, walletId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Estimate fee for the transaction. The estimate is made by assembling multiple transactions and analyzing the distribution of their fees. The estimated_max is the highest fee observed, and the estimated_min is the fee which is lower than at least 90% of the fees observed.
     * @summary Estimate Fee
    ...
    TransactionsApi.prototype.postTransactionFee = function (body, walletId, options) {
        var _this = this;
        return exports.TransactionsApiFp(this.configuration).postTransactionFee(body, walletId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
