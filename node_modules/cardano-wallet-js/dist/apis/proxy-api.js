...
exports.ProxyApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        postExternalTransaction: function (body, options) {
            return exports.ProxyApiFp(configuration).postExternalTransaction(body, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var ProxyApi = /** @class */ (function (_super) {
    ...
    ProxyApi.prototype.postExternalTransaction = function (body, options) {
        var _this = this;
        return exports.ProxyApiFp(this.configuration).postExternalTransaction(body, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return ProxyApi;
}(base_1.BaseAPI));
