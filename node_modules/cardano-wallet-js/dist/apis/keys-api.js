...
exports.KeysApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        getWalletKey: function (walletId, role, index, options) {
            return exports.KeysApiFp(configuration).getWalletKey(walletId, role, index, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p> Retrieve account public key from the wallet.  <b>Note:</b> Only `Hard` indexes are supported by this endpoint.
         * @summary Create
         ...
         */
        postAccountKey: function (body, walletId, index, options) {
            return exports.KeysApiFp(configuration).postAccountKey(body, walletId, index, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var KeysApi = /** @class */ (function (_super) {
    ...
    KeysApi.prototype.getWalletKey = function (walletId, role, index, options) {
        var _this = this;
        return exports.KeysApiFp(this.configuration).getWalletKey(walletId, role, index, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p> Retrieve account public key from the wallet.  <b>Note:</b> Only `Hard` indexes are supported by this endpoint.
     * @summary Create
    ...
    KeysApi.prototype.postAccountKey = function (body, walletId, index, options) {
        var _this = this;
        return exports.KeysApiFp(this.configuration).postAccountKey(body, walletId, index, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return KeysApi;
}(base_1.BaseAPI));
