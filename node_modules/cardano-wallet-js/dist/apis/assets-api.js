        ...
        listAssets: function (walletId, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarPath = "/wallets/{walletId}/assets"
                        .replace("{" + "walletId" + "}", encodeURIComponent(String(walletId)));
                    localVarUrlObj = new URL(localVarPath, 'https://example.com');
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
...
exports.AssetsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        getAsset: function (walletId, policyId, assetName, options) {
            return exports.AssetsApiFp(configuration).getAsset(walletId, policyId, assetName, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Fetch the the asset from `policy_id` with an empty name.  The asset must be associated with the wallet.
         * @summary Get Asset (empty name)
         ...
         */
        getAssetDefault: function (walletId, policyId, options) {
            return exports.AssetsApiFp(configuration).getAssetDefault(walletId, policyId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * List all assets associated with the wallet, and their metadata if known.  An asset is _associated_ with a wallet if it is involved in a transaction of the wallet.
         * @summary List Assets
         ...
         */
        listAssets: function (walletId, options) {
            return exports.AssetsApiFp(configuration).listAssets(walletId, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var AssetsApi = /** @class */ (function (_super) {
    ...
    AssetsApi.prototype.getAsset = function (walletId, policyId, assetName, options) {
        var _this = this;
        return exports.AssetsApiFp(this.configuration).getAsset(walletId, policyId, assetName, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Fetch the the asset from `policy_id` with an empty name.  The asset must be associated with the wallet.
     * @summary Get Asset (empty name)
    ...
    AssetsApi.prototype.getAssetDefault = function (walletId, policyId, options) {
        var _this = this;
        return exports.AssetsApiFp(this.configuration).getAssetDefault(walletId, policyId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * List all assets associated with the wallet, and their metadata if known.  An asset is _associated_ with a wallet if it is involved in a transaction of the wallet.
     * @summary List Assets
    ...
    AssetsApi.prototype.listAssets = function (walletId, options) {
        var _this = this;
        return exports.AssetsApiFp(this.configuration).listAssets(walletId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return AssetsApi;
}(base_1.BaseAPI));
