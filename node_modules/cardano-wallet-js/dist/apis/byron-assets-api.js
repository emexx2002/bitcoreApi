        ...
        listByronAssets: function (walletId, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarPath = "/byron-wallets/{walletId}/assets"
                        .replace("{" + "walletId" + "}", encodeURIComponent(String(walletId)));
                    localVarUrlObj = new URL(localVarPath, 'https://example.com');
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
...
exports.ByronAssetsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        getByronAsset: function (walletId, policyId, assetName, options) {
            return exports.ByronAssetsApiFp(configuration).getByronAsset(walletId, policyId, assetName, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Fetch the the asset from `policy_id` with an empty name.  The asset must be associated with the wallet.
         * @summary Get Asset (empty name)
         ...
         */
        getByronAssetDefault: function (walletId, policyId, options) {
            return exports.ByronAssetsApiFp(configuration).getByronAssetDefault(walletId, policyId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * List all assets associated with the wallet, and their metadata if known.  An asset is _associated_ with a wallet if it is involved in a transaction of the wallet.
         * @summary List Assets
         ...
         */
        listByronAssets: function (walletId, options) {
            return exports.ByronAssetsApiFp(configuration).listByronAssets(walletId, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var ByronAssetsApi = /** @class */ (function (_super) {
    ...
    ByronAssetsApi.prototype.getByronAsset = function (walletId, policyId, assetName, options) {
        var _this = this;
        return exports.ByronAssetsApiFp(this.configuration).getByronAsset(walletId, policyId, assetName, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Fetch the the asset from `policy_id` with an empty name.  The asset must be associated with the wallet.
     * @summary Get Asset (empty name)
    ...
    ByronAssetsApi.prototype.getByronAssetDefault = function (walletId, policyId, options) {
        var _this = this;
        return exports.ByronAssetsApiFp(this.configuration).getByronAssetDefault(walletId, policyId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * List all assets associated with the wallet, and their metadata if known.  An asset is _associated_ with a wallet if it is involved in a transaction of the wallet.
     * @summary List Assets
    ...
    ByronAssetsApi.prototype.listByronAssets = function (walletId, options) {
        var _this = this;
        return exports.ByronAssetsApiFp(this.configuration).listByronAssets(walletId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
