        ...
        byronSelectCoins: function (body, walletId, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarPath = "/byron-wallets/{walletId}/coin-selections/random"
...
exports.ByronCoinSelectionsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        byronSelectCoins: function (body, walletId, options) {
            return exports.ByronCoinSelectionsApiFp(configuration).byronSelectCoins(body, walletId, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var ByronCoinSelectionsApi = /** @class */ (function (_super) {
    ...
    ByronCoinSelectionsApi.prototype.byronSelectCoins = function (body, walletId, options) {
        var _this = this;
        return exports.ByronCoinSelectionsApiFp(this.configuration).byronSelectCoins(body, walletId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
