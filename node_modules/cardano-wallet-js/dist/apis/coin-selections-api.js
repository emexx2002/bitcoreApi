        ...
        selectCoins: function (body, walletId, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarPath = "/wallets/{walletId}/coin-selections/random"
...
exports.CoinSelectionsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        selectCoins: function (body, walletId, options) {
            return exports.CoinSelectionsApiFp(configuration).selectCoins(body, walletId, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var CoinSelectionsApi = /** @class */ (function (_super) {
    ...
    CoinSelectionsApi.prototype.selectCoins = function (body, walletId, options) {
        var _this = this;
        return exports.CoinSelectionsApiFp(this.configuration).selectCoins(body, walletId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
