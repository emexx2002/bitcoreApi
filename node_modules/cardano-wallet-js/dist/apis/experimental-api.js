...
exports.ExperimentalApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        signMetadata: function (body, walletId, role, index, options) {
            return exports.ExperimentalApiFp(configuration).signMetadata(body, walletId, role, index, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var ExperimentalApi = /** @class */ (function (_super) {
    ...
    ExperimentalApi.prototype.signMetadata = function (body, walletId, role, index, options) {
        var _this = this;
        return exports.ExperimentalApiFp(this.configuration).signMetadata(body, walletId, role, index, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
