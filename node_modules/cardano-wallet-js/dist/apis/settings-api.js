...
exports.SettingsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        getSettings: function (options) {
            return exports.SettingsApiFp(configuration).getSettings(options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Overwrite current settings.
         * @summary Update settings
         ...
         */
        putSettings: function (body, options) {
            return exports.SettingsApiFp(configuration).putSettings(body, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var SettingsApi = /** @class */ (function (_super) {
    ...
    SettingsApi.prototype.getSettings = function (options) {
        var _this = this;
        return exports.SettingsApiFp(this.configuration).getSettings(options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Overwrite current settings.
     * @summary Update settings
    ...
    SettingsApi.prototype.putSettings = function (body, options) {
        var _this = this;
        return exports.SettingsApiFp(this.configuration).putSettings(body, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return SettingsApi;
}(base_1.BaseAPI));
