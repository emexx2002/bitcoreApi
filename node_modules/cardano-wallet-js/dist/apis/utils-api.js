...
exports.UtilsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        getCurrentSmashHealth: function (url, options) {
            return exports.UtilsApiFp(configuration).getCurrentSmashHealth(url, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var UtilsApi = /** @class */ (function (_super) {
    ...
    UtilsApi.prototype.getCurrentSmashHealth = function (url, options) {
        var _this = this;
        return exports.UtilsApiFp(this.configuration).getCurrentSmashHealth(url, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return UtilsApi;
}(base_1.BaseAPI));
