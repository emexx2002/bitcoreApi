...
exports.NetworkApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        getNetworkClock: function (forceNtpCheck, options) {
            return exports.NetworkApiFp(configuration).getNetworkClock(forceNtpCheck, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>
         * @summary Information
         ...
         */
        getNetworkInformation: function (options) {
            return exports.NetworkApiFp(configuration).getNetworkInformation(options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Returns the set of network parameters for the current epoch.
         * @summary Parameters
         ...
         */
        getNetworkParameters: function (options) {
            return exports.NetworkApiFp(configuration).getNetworkParameters(options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var NetworkApi = /** @class */ (function (_super) {
    ...
    NetworkApi.prototype.getNetworkClock = function (forceNtpCheck, options) {
        var _this = this;
        return exports.NetworkApiFp(this.configuration).getNetworkClock(forceNtpCheck, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>
     * @summary Information
    ...
    NetworkApi.prototype.getNetworkInformation = function (options) {
        var _this = this;
        return exports.NetworkApiFp(this.configuration).getNetworkInformation(options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Returns the set of network parameters for the current epoch.
     * @summary Parameters
    ...
    NetworkApi.prototype.getNetworkParameters = function (options) {
        var _this = this;
        return exports.NetworkApiFp(this.configuration).getNetworkParameters(options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return NetworkApi;
}(base_1.BaseAPI));
