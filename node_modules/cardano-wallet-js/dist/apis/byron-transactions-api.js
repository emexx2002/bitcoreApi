        ...
        listByronTransactions: function (walletId, start, end, order, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarPath = "/byron-wallets/{walletId}/transactions"
                        .replace("{" + "walletId" + "}", encodeURIComponent(String(walletId)));
                    localVarUrlObj = new URL(localVarPath, 'https://example.com');
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
        ...
        postByronTransactionFee: function (body, walletId, options) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    localVarPath = "/byron-wallets/{walletId}/payment-fees"
                        .replace("{" + "walletId" + "}", encodeURIComponent(String(walletId)));
                    localVarUrlObj = new URL(localVarPath, 'https://example.com');
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
...
exports.ByronTransactionsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        deleteByronTransaction: function (walletId, transactionId, options) {
            return exports.ByronTransactionsApiFp(configuration).deleteByronTransaction(walletId, transactionId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Get transaction by id.
         * @summary Get
         ...
         */
        getByronTransaction: function (walletId, transactionId, options) {
            return exports.ByronTransactionsApiFp(configuration).getByronTransaction(walletId, transactionId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  List all incoming and outgoing transactions for the given wallet.
         * @summary List
         ...
         */
        listByronTransactions: function (walletId, start, end, order, options) {
            return exports.ByronTransactionsApiFp(configuration).listByronTransactions(walletId, start, end, order, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Create and send transaction from the wallet.
         * @summary Create
         ...
         */
        postByronTransaction: function (body, walletId, options) {
            return exports.ByronTransactionsApiFp(configuration).postByronTransaction(body, walletId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Estimate fee for the transaction.
         * @summary Estimate Fee
         ...
         */
        postByronTransactionFee: function (body, walletId, options) {
            return exports.ByronTransactionsApiFp(configuration).postByronTransactionFee(body, walletId, options).then(function (request) { return request(axios, basePath); });
        },
    };
};
/**
...
var ByronTransactionsApi = /** @class */ (function (_super) {
    ...
    ByronTransactionsApi.prototype.deleteByronTransaction = function (walletId, transactionId, options) {
        var _this = this;
        return exports.ByronTransactionsApiFp(this.configuration).deleteByronTransaction(walletId, transactionId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Get transaction by id.
     * @summary Get
    ...
    ByronTransactionsApi.prototype.getByronTransaction = function (walletId, transactionId, options) {
        var _this = this;
        return exports.ByronTransactionsApiFp(this.configuration).getByronTransaction(walletId, transactionId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  List all incoming and outgoing transactions for the given wallet.
     * @summary List
    ...
    ByronTransactionsApi.prototype.listByronTransactions = function (walletId, start, end, order, options) {
        var _this = this;
        return exports.ByronTransactionsApiFp(this.configuration).listByronTransactions(walletId, start, end, order, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Create and send transaction from the wallet.
     * @summary Create
    ...
    ByronTransactionsApi.prototype.postByronTransaction = function (body, walletId, options) {
        var _this = this;
        return exports.ByronTransactionsApiFp(this.configuration).postByronTransaction(body, walletId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * <p align=\"right\">status: <strong>stable</strong></p>  Estimate fee for the transaction.
     * @summary Estimate Fee
    ...
    ByronTransactionsApi.prototype.postByronTransactionFee = function (body, walletId, options) {
        var _this = this;
        return exports.ByronTransactionsApiFp(this.configuration).postByronTransactionFee(body, walletId, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
